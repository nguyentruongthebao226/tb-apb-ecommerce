...
namespace TheBao.AbpEcommerce.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AbpEcommerce") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AbpEcommerce", DisplayName = "AbpEcommerce API", Resources = { "AbpEcommerce" }
            });
        }
    }
